...
| RM-03 | P1 | Contrato exige handoff, mas `ai_squad` não pode escrever em `.context/handoffs` | `repos/auraxis-api/ai_squad/tools/tool_security.py` | Expandir allowlist para `.context/handoffs` e `.context/reports` | Concluído |

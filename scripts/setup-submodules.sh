...
echo "  2. Read .context/08_agent_contract.md"
echo "  3. Read .context/01_status_atual.md"
echo "  4. Acquire agent lock: scripts/agent-lock.sh acquire <name> <repo> '<task>'"
echo "  5. Create a feature branch and start working"
echo "════════════════════════════════════════════════════════"
echo ""
